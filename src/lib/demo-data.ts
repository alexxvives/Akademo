...
export function generateDemoStudents(count: number = DEMO_STUDENT_COUNT.TOTAL): DemoStudent[] {
  ...
  const hardcodedStudents: DemoStudent[] = [
    // Active students (last 24h) - 76% (increased from 30%)
    ...
    { id: 'demo-s25', firstName: 'Isabel', lastName: 'Sánchez', email: 'estudiante25@demo.com', enrolledAt: new Date(baseDate.getTime() - 41 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 4 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s29', firstName: 'Elena', lastName: 'Torres', email: 'estudiante29@demo.com', enrolledAt: new Date(baseDate.getTime() - 67 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 2 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s41', firstName: 'Pedro', lastName: 'García', email: 'estudiante41@demo.com', enrolledAt: new Date(baseDate.getTime() - 60 * 24 * 60 * 60 * 1000).toISOString(), className: 'Programación Web', lastLoginAt: new Date(baseDate.getTime() - 10 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s42', firstName: 'Sofía', lastName: 'Rodríguez', email: 'estudiante42@demo.com', enrolledAt: new Date(baseDate.getTime() - 68 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 12 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s43', firstName: 'Diego', lastName: 'Martínez', email: 'estudiante43@demo.com', enrolledAt: new Date(baseDate.getTime() - 75 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 15 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s44', firstName: 'Elena', lastName: 'López', email: 'estudiante44@demo.com', enrolledAt: new Date(baseDate.getTime() - 62 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 17 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s45', firstName: 'Javier', lastName: 'Sánchez', email: 'estudiante45@demo.com', enrolledAt: new Date(baseDate.getTime() - 70 * 24 * 60 * 60 * 1000).toISOString(), className: 'Programación Web', lastLoginAt: new Date(baseDate.getTime() - 19 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s46', firstName: 'Juan', lastName: 'Pérez', email: 'estudiante46@demo.com', enrolledAt: new Date(baseDate.getTime() - 77 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 21 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s47', firstName: 'María', lastName: 'Gómez', email: 'estudiante47@demo.com', enrolledAt: new Date(baseDate.getTime() - 64 * 24 * 60 * 60 * 1000).toISOString(), className: 'Programación Web', lastLoginAt: new Date(baseDate.getTime() - 23 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s48', firstName: 'Carlos', lastName: 'Fernández', email: 'estudiante48@demo.com', enrolledAt: new Date(baseDate.getTime() - 71 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 1 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s50', firstName: 'Luis', lastName: 'Díaz', email: 'estudiante50@demo.com', enrolledAt: new Date(baseDate.getTime() - 66 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 5 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s51', firstName: 'Carmen', lastName: 'García', email: 'estudiante51@demo.com', enrolledAt: new Date(baseDate.getTime() - 73 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 7 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s52', firstName: 'José', lastName: 'Rodríguez', email: 'estudiante52@demo.com', enrolledAt: new Date(baseDate.getTime() - 61 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 9 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s53', firstName: 'Laura', lastName: 'Martínez', email: 'estudiante53@demo.com', enrolledAt: new Date(baseDate.getTime() - 69 * 24 * 60 * 60 * 1000).toISOString(), className: 'Programación Web', lastLoginAt: new Date(baseDate.getTime() - 11 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s54', firstName: 'Miguel', lastName: 'López', email: 'estudiante54@demo.com', enrolledAt: new Date(baseDate.getTime() - 76 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 13 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s55', firstName: 'Isabel', lastName: 'Sánchez', email: 'estudiante55@demo.com', enrolledAt: new Date(baseDate.getTime() - 63 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 15 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s58', firstName: 'Diego', lastName: 'Fernández', email: 'estudiante58@demo.com', enrolledAt: new Date(baseDate.getTime() - 66 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 3 * 24 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s61', firstName: 'Juan', lastName: 'García', email: 'estudiante61@demo.com', enrolledAt: new Date(baseDate.getTime() - 70 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 4 * 24 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s66', firstName: 'Carmen', lastName: 'Pérez', email: 'estudiante66@demo.com', enrolledAt: new Date(baseDate.getTime() - 67 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 1 * 24 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s70', firstName: 'Isabel', lastName: 'Díaz', email: 'estudiante70@demo.com', enrolledAt: new Date(baseDate.getTime() - 78 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 5 * 24 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s74', firstName: 'Elena', lastName: 'López', email: 'estudiante74@demo.com', enrolledAt: new Date(baseDate.getTime() - 68 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 20 * 24 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s78', firstName: 'Carlos', lastName: 'Fernández', email: 'estudiante78@demo.com', enrolledAt: new Date(baseDate.getTime() - 70 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 22 * 24 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s82', firstName: 'José', lastName: 'Rodríguez', email: 'estudiante82@demo.com', enrolledAt: new Date(baseDate.getTime() - 61 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 25 * 24 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s86', firstName: 'Pedro', lastName: 'Pérez', email: 'estudiante86@demo.com', enrolledAt: new Date(baseDate.getTime() - 72 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 21 * 24 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s90', firstName: 'Javier', lastName: 'Díaz', email: 'estudiante90@demo.com', enrolledAt: new Date(baseDate.getTime() - 63 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 24 * 24 * 60 * 60 * 1000).toISOString() },
    // Never logged in - 10%
    ...
    { id: 'demo-s101', firstName: 'Antonio', lastName: 'García', email: 'estudiante101@demo.com', enrolledAt: new Date(baseDate.getTime() - 45 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 5 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s102', firstName: 'Beatriz', lastName: 'Rodríguez', email: 'estudiante102@demo.com', enrolledAt: new Date(baseDate.getTime() - 50 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 7 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s104', firstName: 'Daniel', lastName: 'López', email: 'estudiante104@demo.com', enrolledAt: new Date(baseDate.getTime() - 60 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 14 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s105', firstName: 'Eva', lastName: 'Sánchez', email: 'estudiante105@demo.com', enrolledAt: new Date(baseDate.getTime() - 65 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 18 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s106', firstName: 'Fernando', lastName: 'Pérez', email: 'estudiante106@demo.com', enrolledAt: new Date(baseDate.getTime() - 42 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 9 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s107', firstName: 'Gloria', lastName: 'Gómez', email: 'estudiante107@demo.com', enrolledAt: new Date(baseDate.getTime() - 47 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 22 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s108', firstName: 'Héctor', lastName: 'Fernández', email: 'estudiante108@demo.com', enrolledAt: new Date(baseDate.getTime() - 52 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 12 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s109', firstName: 'Irene', lastName: 'Torres', email: 'estudiante109@demo.com', enrolledAt: new Date(baseDate.getTime() - 57 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 3 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s110', firstName: 'Jorge', lastName: 'Díaz', email: 'estudiante110@demo.com', enrolledAt: new Date(baseDate.getTime() - 62 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 4 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s111', firstName: 'Karina', lastName: 'García', email: 'estudiante111@demo.com', enrolledAt: new Date(baseDate.getTime() - 67 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 2 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s112', firstName: 'Luis', lastName: 'Rodríguez', email: 'estudiante112@demo.com', enrolledAt: new Date(baseDate.getTime() - 72 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 5 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s113', firstName: 'Marta', lastName: 'Martínez', email: 'estudiante113@demo.com', enrolledAt: new Date(baseDate.getTime() - 49 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 1 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s114', firstName: 'Natalia', lastName: 'López', email: 'estudiante114@demo.com', enrolledAt: new Date(baseDate.getTime() - 54 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 3 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s115', firstName: 'Oscar', lastName: 'Sánchez', email: 'estudiante115@demo.com', enrolledAt: new Date(baseDate.getTime() - 59 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 6 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s116', firstName: 'Patricia', lastName: 'Pérez', email: 'estudiante116@demo.com', enrolledAt: new Date(baseDate.getTime() - 64 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 4 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s117', firstName: 'Quique', lastName: 'Gómez', email: 'estudiante117@demo.com', enrolledAt: new Date(baseDate.getTime() - 69 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 7 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s118', firstName: 'Raúl', lastName: 'Fernández', email: 'estudiante118@demo.com', enrolledAt: new Date(baseDate.getTime() - 74 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 2 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s119', firstName: 'Sara', lastName: 'Torres', email: 'estudiante119@demo.com', enrolledAt: new Date(baseDate.getTime() - 51 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 11 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s120', firstName: 'Tomás', lastName: 'Díaz', email: 'estudiante120@demo.com', enrolledAt: new Date(baseDate.getTime() - 56 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 14 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s121', firstName: 'Ursula', lastName: 'García', email: 'estudiante121@demo.com', enrolledAt: new Date(baseDate.getTime() - 61 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 18 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s122', firstName: 'Víctor', lastName: 'Rodríguez', email: 'estudiante122@demo.com', enrolledAt: new Date(baseDate.getTime() - 66 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 22 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s123', firstName: 'Wendy', lastName: 'Martínez', email: 'estudiante123@demo.com', enrolledAt: new Date(baseDate.getTime() - 71 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 26 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s124', firstName: 'Xavier', lastName: 'López', email: 'estudiante124@demo.com', enrolledAt: new Date(baseDate.getTime() - 48 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 9 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s125', firstName: 'Yolanda', lastName: 'Sánchez', email: 'estudiante125@demo.com', enrolledAt: new Date(baseDate.getTime() - 53 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 15 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s126', firstName: 'Zoe', lastName: 'Pérez', email: 'estudiante126@demo.com', enrolledAt: new Date(baseDate.getTime() - 58 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 19 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s127', firstName: 'Alberto', lastName: 'Gómez', email: 'estudiante127@demo.com', enrolledAt: new Date(baseDate.getTime() - 63 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 27 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s128', firstName: 'Brenda', lastName: 'Fernández', email: 'estudiante128@demo.com', enrolledAt: new Date(baseDate.getTime() - 68 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: new Date(baseDate.getTime() - 29 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s129', firstName: 'Camilo', lastName: 'Torres', email: 'estudiante129@demo.com', enrolledAt: new Date(baseDate.getTime() - 73 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: null },
    { id: 'demo-s130', firstName: 'Diana', lastName: 'Díaz', email: 'estudiante130@demo.com', enrolledAt: new Date(baseDate.getTime() - 78 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico', lastLoginAt: null },
    
    // Additional Matemáticas Avanzadas students (demo-s131 to demo-s140) - 10 students
    { id: 'demo-s131', firstName: 'Eduardo', lastName: 'García', email: 'estudiante131@demo.com', enrolledAt: new Date(baseDate.getTime() - 44 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 6 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s132', firstName: 'Fernanda', lastName: 'Rodríguez', email: 'estudiante132@demo.com', enrolledAt: new Date(baseDate.getTime() - 49 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 8 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s133', firstName: 'Germán', lastName: 'Martínez', email: 'estudiante133@demo.com', enrolledAt: new Date(baseDate.getTime() - 53 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 11 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s134', firstName: 'Helena', lastName: 'López', email: 'estudiante134@demo.com', enrolledAt: new Date(baseDate.getTime() - 57 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 15 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s135', firstName: 'Ignacio', lastName: 'Sánchez', email: 'estudiante135@demo.com', enrolledAt: new Date(baseDate.getTime() - 61 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 18 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s136', firstName: 'Julia', lastName: 'Pérez', email: 'estudiante136@demo.com', enrolledAt: new Date(baseDate.getTime() - 46 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 2 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s137', firstName: 'Kevin', lastName: 'Gómez', email: 'estudiante137@demo.com', enrolledAt: new Date(baseDate.getTime() - 51 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 4 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s138', firstName: 'Lorena', lastName: 'Fernández', email: 'estudiante138@demo.com', enrolledAt: new Date(baseDate.getTime() - 55 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 6 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s139', firstName: 'Marcos', lastName: 'Torres', email: 'estudiante139@demo.com', enrolledAt: new Date(baseDate.getTime() - 59 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: new Date(baseDate.getTime() - 12 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s140', firstName: 'Nora', lastName: 'Díaz', email: 'estudiante140@demo.com', enrolledAt: new Date(baseDate.getTime() - 63 * 24 * 60 * 60 * 1000).toISOString(), className: 'Matemáticas Avanzadas', lastLoginAt: null },

    // Additional Física Cuántica students (demo-s141 to demo-s154) - 14 students
    { id: 'demo-s141', firstName: 'Olga', lastName: 'García', email: 'estudiante141@demo.com', enrolledAt: new Date(baseDate.getTime() - 45 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 7 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s142', firstName: 'Pablo', lastName: 'Rodríguez', email: 'estudiante142@demo.com', enrolledAt: new Date(baseDate.getTime() - 48 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 9 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s143', firstName: 'Queralt', lastName: 'Martínez', email: 'estudiante143@demo.com', enrolledAt: new Date(baseDate.getTime() - 52 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 13 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s144', firstName: 'Ricardo', lastName: 'López', email: 'estudiante144@demo.com', enrolledAt: new Date(baseDate.getTime() - 56 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 16 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s145', firstName: 'Silvia', lastName: 'Sánchez', email: 'estudiante145@demo.com', enrolledAt: new Date(baseDate.getTime() - 60 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 19 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s146', firstName: 'Telma', lastName: 'Pérez', email: 'estudiante146@demo.com', enrolledAt: new Date(baseDate.getTime() - 64 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 22 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s147', firstName: 'Ulises', lastName: 'Gómez', email: 'estudiante147@demo.com', enrolledAt: new Date(baseDate.getTime() - 47 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 2 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s148', firstName: 'Valentina', lastName: 'Fernández', email: 'estudiante148@demo.com', enrolledAt: new Date(baseDate.getTime() - 50 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 3 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s149', firstName: 'Walter', lastName: 'Torres', email: 'estudiante149@demo.com', enrolledAt: new Date(baseDate.getTime() - 54 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 5 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s150', firstName: 'Ximena', lastName: 'Díaz', email: 'estudiante150@demo.com', enrolledAt: new Date(baseDate.getTime() - 58 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 8 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s151', firstName: 'Yago', lastName: 'García', email: 'estudiante151@demo.com', enrolledAt: new Date(baseDate.getTime() - 62 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 11 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s152', firstName: 'Zaira', lastName: 'Rodríguez', email: 'estudiante152@demo.com', enrolledAt: new Date(baseDate.getTime() - 66 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 15 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s153', firstName: 'Adrián', lastName: 'Martínez', email: 'estudiante153@demo.com', enrolledAt: new Date(baseDate.getTime() - 70 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: new Date(baseDate.getTime() - 20 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s154', firstName: 'Blanca', lastName: 'López', email: 'estudiante154@demo.com', enrolledAt: new Date(baseDate.getTime() - 74 * 24 * 60 * 60 * 1000).toISOString(), className: 'Física Cuántica', lastLoginAt: null },
  ];
