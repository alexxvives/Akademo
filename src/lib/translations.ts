export const translations = {
  es: {
    ...
    heroAudiences: [
      ...
      'Academias que buscan fidelizar a sus estudiantes',
    ],
    ...
    watermarkFeature1Desc: 'Elige cada cuándo aparece durante la reproducción, disuade la grabación de pantalla.',
    ...
    managementFeature1Desc: 'Cada profesor gestiona sus propias clases y vídeos de forma independiente.',
    managementFeature2: 'Gestión de estudiantes',
    managementFeature2Desc: 'Inscripciones, accesos, pagos y seguimiento de progreso en un solo lugar.',
  ...
  en: {
    ...
    managementFeature1Desc: 'Each teacher manages their own classes and videos independently.',
    managementFeature2: 'Student management',
    managementFeature2Desc: 'Enrollments, access, payments, and progress tracking in one place.',
