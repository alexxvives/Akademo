...
export default function AcademyGrades() {
  ...
  const filteredAverages = searchQuery.trim()
    ? averages.filter(a => 
    ...
    <div className="space-y-6">
      ...
      {filteredAverages.length === 0 ? (
          ...
          <>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
              <div className="px-6 py-3 bg-gray-50 border-b border-gray-200">
                <span className="text-sm text-gray-600">Mostrando <span className="font-semibold">{filteredAverages.length}</span> estudiante{filteredAverages.length !== 1 ? 's' : ''}</span>
              </div>
