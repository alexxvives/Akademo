...
export default function ClassCard({ classItem, activeStreams, onClassClick, onViewDocument }: ClassCardProps) {
  ...
  const isBanned = classItem.enrollmentStatus === 'BANNED';
        ...
        <div className="flex-1 min-w-0 pr-10 sm:pr-0">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
            <div className="flex flex-wrap items-center gap-2">
              ...
              {isBanned && (
                <div className="relative group/banned">
                  <svg className="w-6 h-6 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
                  </svg>
                  <div className="hidden sm:block absolute -bottom-8 left-1/2 -translate-x-1/2 bg-gray-900 text-white text-xs px-2 py-1 rounded whitespace-nowrap opacity-0 group-hover/banned:opacity-100 transition-opacity z-10">
                    Acceso suspendido
                  </div>
                </div>
              )}
