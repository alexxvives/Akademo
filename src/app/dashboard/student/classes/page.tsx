                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500">
                    <span className="flex items-center gap-1">
                      ...
                      {classItem.startDate 
                        ? `Empieza ${new Date(classItem.startDate).toLocaleDateString('es-ES', { day: 'numeric', month: 'long', year: 'numeric' })}`
                        : `Creada en ${new Date(classItem.createdAt).toLocaleDateString('es-ES', { day: 'numeric', month: 'long', year: 'numeric' })}`
                      }
                    </span>
                    <span className="flex items-center gap-1">
                    ...
                    <span className="flex items-center gap-1">
                      ...
                      <span className="font-semibold text-gray-700">{classItem.lessonCount}</span> Clases
                    </span>
                    <span className="flex items-center gap-1">
