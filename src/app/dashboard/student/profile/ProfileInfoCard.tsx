...
export function ProfileInfoCard({ user, formData, setFormData, handleSaveProfile, emailChangeStep, pendingEmailChange, emailChangeCode, setEmailChangeCode, originalEmail, handleRequestEmailChange, handleConfirmEmailChange, handleCancelEmailChange }: ProfileInfoCardProps) {
