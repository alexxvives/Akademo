...
export default function ClassPage() {
  ...
  const loadData = async () => {
    try {
      ...
      // Check if access is locked due to unpaid monthly enrollment
  ...
  // Block access if student is behind on payments
  if (accessLocked) {
    return (
      ...
      <div className="space-y-6">
        ...
        {!selectedLesson && classData && (
          <>
            ...
            {/* Title row - flex with live badge on the right */}
            <div className="flex items-start justify-between gap-4 mb-4">
              ...
              {/* Live Stream Indicator - top-right of content header */}
              {activeStream && (
