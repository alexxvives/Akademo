...
import { SkeletonClasses, SkeletonList } from '@/components/ui/SkeletonLoader';
...
export function ClassesPage({ role }: ClassesPageProps) {
  ...
  if (loading) {
    return role === 'ACADEMY' ? <SkeletonClasses /> : <SkeletonList rows={10} />;
  }
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {/* WhatsApp (academy only) */}
                      {role === 'ACADEMY' && cls.whatsappGroupLink && (
                        <a
                      ...
                      {/* Rating (admin) */}
                      {role === 'ADMIN' && cls.avgRating != null && cls.avgRating > 0 && (
                    ...
                    <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500">
                      ...
                      {/* Admin: student + lesson + video + document counts */}
                      {role === 'ADMIN' && (
                        <>
                          <span className="flex items-center gap-1">
                            <svg
                          ...
                          <span className="flex items-center gap-1">
                            ...
                            <span className="font-semibold text-gray-700">{cls.lessonCount}</span> Lección
                            {cls.lessonCount !== 1 ? 'es' : ''}
                          </span>
                          {cls.videoCount !== undefined && (
                            <span className="flex items-center gap-1">
                              ...
                              <span className="font-semibold text-gray-700">{cls.videoCount}</span> Video
                              {cls.videoCount !== 1 ? 's' : ''}
                            </span>
                          )}
                          {cls.documentCount !== undefined && (
                            <span className="flex items-center gap-1">
                              ...
                              <span className="font-semibold text-gray-700">{cls.documentCount || 0}</span>{' '}
                              Documento{(cls.documentCount || 0) !== 1 ? 's' : ''}
                            </span>
                          )}
                        </>
                      )}
