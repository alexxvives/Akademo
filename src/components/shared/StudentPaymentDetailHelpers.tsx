...
export interface StudentPaymentDetailModalProps {
  isOpen: boolean;
  onClose: () => void;
  studentName: string;
  studentEmail: string;
...
export function getPaymentStatusBadge(payment: StudentPayment) {
...
interface PaymentListContentProps {
  isFilterChanging: boolean;
  filteredPayments: StudentPayment[];
}

export function PaymentListContent({ isFilterChanging, filteredPayments }: PaymentListContentProps) {
  if (isFilterChanging) {
    return (
