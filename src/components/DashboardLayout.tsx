    ...
    switch (role) {
      ...
      case 'TEACHER':
        return [
          ...
          { label: 'En vivo', href: '/dashboard/teacher/live', badge: activeStreams.length > 0 ? activeStreams.length : undefined, badgeColor: 'bg-red-500', icon: (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>) },
      ...
      case 'STUDENT':
        return [
          ...
          { label: 'En vivo', href: '/dashboard/student/live', badge: activeStreams.length > 0 ? activeStreams.length : undefined, badgeColor: 'bg-red-500', icon: (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>) },
      ...
      case 'ACADEMY':
        const academyMenuItems: MenuItem[] = [
          ...
          { label: 'En vivo', href: '/dashboard/academy/live', badge: activeStreams.length > 0 ? activeStreams.length : undefined, badgeColor: 'bg-red-500', icon: (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>) },
