  ...
  return (
    <div className="space-y-4">
      ...
      <div className="pt-4 border-t border-gray-200">
              ...
              <div className="mt-2 space-y-2">
                {formData.videos.map((v, i) => (
                  <div key={`video-${i}-${v.file.name}`} className="flex items-center gap-3 p-3 bg-gray-50 border border-gray-200 rounded-lg">
                    ...
                    <button type="button" onClick={() => setFormData(prev => ({ ...prev, videos: prev.videos.filter((_, j) => j !== i) }))} className="text-xs text-red-600 bg-red-100 hover:bg-red-200 px-2 py-1 rounded transition-colors">
                      Eliminar
                    </button>
                  </div>
                ))}
        ...
        {/* Nuevos documentos — full width below */}
        <div className="mt-4">
            ...
            <div className="mt-2 space-y-2">
              {formData.documents.map((d, i) => (
                <div key={`doc-${i}-${d.file.name}`} className="flex items-center gap-3 p-3 bg-gray-50 border border-gray-200 rounded-lg">
                  ...
                  <button type="button" onClick={() => setFormData(prev => ({ ...prev, documents: prev.documents.filter((_, j) => j !== i) }))} className="text-xs text-red-600 bg-red-100 hover:bg-red-200 px-2 py-1 rounded transition-colors">
                    Eliminar
                  </button>
                </div>
              ))}
