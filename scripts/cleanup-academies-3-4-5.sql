-- Cleanup script: full reset for Academy Three, Four, Five
...
-- 4. Delete User accounts (students and teachers) for these academies
...
-- 5. Delete all classes (asignaturas) for these academies
